...
public class ItemRenderIronTank extends ItemRenderTank {
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        switch (meta) {
            case 0:
                FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation(Texture.Blocks.MODEL_SMALL_IRON_TANK));
                break;
            case 1:
                FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation(Texture.Blocks.MODEL_SMALL_HOLLOW_IRON_TANK));
                break;
            default:
