...
public class Recipes {
    ...
    public static void init() {
        ...
        FluidInfuserRegister.addRecipe(new FluidStack(FluidRegistry.getFluid("lava"), 4 * 200), new ItemStack(ModBlocks.blockUpgCSlimyLog, 4), new ItemStack(Blocks.slime_block, 1), 10, new ItemStack(Blocks.planks, 4), 200);
